...
export const fetchProductsCart = createAsyncThunk('cart/fetchProductsCart', async (_, thunkAPI) => {
...
export const fetchProductCartByUserId = createAsyncThunk('cart/fetchProductCartByUserId', async (userId, thunkAPI) => {
